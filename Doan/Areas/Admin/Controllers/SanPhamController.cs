...
namespace Doan.Areas.Admin.Controllers
{
    ...
    public class SanPhamController : Controller
    {
        ...
        public SanPhamController(DoanDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        {
            //var doanDbContext = _context.SanPham.Include(s => s.HangSanXuat).Include(s => s.LoaiSanPham);
